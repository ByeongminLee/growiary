...
const buttonVariants = cva(
  ...
  ' rounded-md text-center cursor-pointer hover:shadow-[none] hover:bg-branding-300 disabled:cursor-default border disabled:border-primary-300',
  {
    variants: {
      variant: {
        default:
